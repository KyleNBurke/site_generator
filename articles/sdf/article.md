...
![a cubic polynomial](cubic_polynomial.png)
...
# Calculating the sign of the distance
...
![edge cases in the crossing number algorithm](crossing_number_edge_cases.png)
...
![quadratic Bézier ray intersections](crossing_number_quad_intersections.png) 
...
![quadratic Bézier with linear y coordinates, xy-plane](bezier_with_linear_y_1.png)
...
![quadratic Bézier with linear y coordinates, yt-plane](bezier_with_linear_y_2.png)
...
![quadratic Bézier with horizontal start and control point](bezier_with_horizontal_start_and_end.png)

a $y_c - y_s = 0$ so in this case we'll need to look at the sign of $y_e - y_s$ instead. Rule four is regarding the intersection point shown in the below example.

![quadratic Bézier with an intersection point between endpoints](bezier_with_intersection_point_between_endpoints.png)
...
![quadratic Bézier with an intersection point at start endpoint](bezier_with_intersection_point_at_start_endpont.png)
